...
export const PaddingSettingsPanel = ({
  ...
  const sides = [
    { key: 'top', label: __('Top', 'themehunk-login-registration') },
    { key: 'right', label: __('Right', 'themehunk-login-registration') },
    { key: 'bottom', label: __('Bottom', 'themehunk-login-registration') },
    { key: 'left', label: __('Left', 'themehunk-login-registration') },
  ];
    ...
    <AccordionSection title={title} defaultOpen={false}>
      <div className="components-border-box-control__header">
        <span className="components-border-box-control__label">
          {__('Padding Settings', 'themehunk-login-registration')}
        </span>
        <Button
