    ...
    <section className="settings-section">
      <div className="settings-card">
        <h2 className="section-title">
          ...
          {__("Integration Settings", "themehunk-login-registration")}
        </h2>
          ...
          <div className="settings-card woocommerce-card">
            <div className="woocommerce-card-header">
              ...
              <div className="woocommerce-info">
                <h3>{__("WordPress Integration", "themehunk-login-registration")}</h3>
                <p>
                  {__(
                ...
                <div className="premium-openeer-toggle">
                    <div className="wordpress-option-slide">
                      ...
                      <label className="slug-label">
                        <strong>{__("Custom Login Slug", "themehunk-login-registration")}</strong>
                      </label>

                      <div className="custom-login-url-row">
                        <TextControl
                          placeholder={__("e.g. login, kuber, signin", "themehunk-login-registration")}
                      ...
                      <span style={{ color: "#888" }}>
                        {__("Final URL:", "themehunk-login-registration")}{" "}
                      </span>
        ...
        <div className="settings-group integration-woocommerce">
          <div className="settings-card woocommerce-card">
            <div className="woocommerce-card-header">
              ...
              <div className="woocommerce-info">
                <h3>{__("WooCommerce Integration", "themehunk-login-registration")}</h3>
                <p>
                  {__(
        ...
        {/* <div className="settings-group integration-woocommerce">
          <div className="settings-card woocommerce-card">
            <div className="woocommerce-card-header">
              ...
              <div className="woocommerce-info">
                <h3>{__("SMTP Integration", "themehunk-login-registration")}</h3>
                <p>
                  {__(
