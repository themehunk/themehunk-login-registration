(function ($) {
    ...
    const applyTextBorder = () => {
        const style = wp.customize('thlogin_typography_general_text_border_style_setting')();
        const width = wp.customize('thlogin_typography_general_text_border_width_setting')();
        const color = wp.customize('thlogin_typography_general_text_border_color_setting')();
    ...
    bindSetting('thlogin_modal_overlay_color_setting', val =>
        applyStyle('.thlogin-popup-overlay', 'background', val)
    );

    bindSetting('thlogin_modal_form_bg_color_setting', val =>
        applyStyle('.thlogin-popup-form-container', 'background-color', val)
    );

    bindSetting('thlogin_modal_form_border_radius_tl_setting', val =>
        applyStyle('.thlogin-popup-form-container', 'border-top-left-radius', val)
    );

    // Login form colors
    bindSetting('thlogin_login_form_bg_color_setting', val =>
        applyStyle('.thlogin-form[data-form-type="login"]', 'background-color', val)
    );

    bindSetting('thlogin_login_form_text_color_setting', val => {
    ...
    // General text color
    bindSetting('thlogin_typography_general_text_color_setting', val => {
    ...
    bindSetting('thlogin_typography_general_text_border_style_setting', applyTextBorder);
    bindSetting('thlogin_typography_general_text_border_width_setting', applyTextBorder);
    bindSetting('thlogin_typography_general_text_border_color_setting', applyTextBorder);

    // Custom CSS injection
    bindSetting('thlogin_custom_css_setting', css => {
