   ...
   public function render() {
    ...
    <?php } else { ?>
        ...
        <?php if ( in_array( $this->layout, ['floating', 'placehold'], true ) ) { ?>
            <div class="floating-wrapper layout-<?php echo esc_attr( $this->layout ); ?> <?php echo esc_attr__($show_icon_in_input ? 'icon-activated-input-wrapper' : ''); ?>">
                <input 
                    class="floating-input <?php echo esc_attr__($show_icon_in_input ? 'icon-activated-input' : ''); ?>"
        ...
        <?php } else { ?>
            ...
            <input 
                class="<?php echo esc_attr__($show_icon_in_input ? 'icon-activated-input' : ''); ?>"
                <?php if ( $show_icon_in_input ) { ?>
                    style="background-image: <?php echo esc_attr( thlogin_get_icon_svg_data_uri( $icon ) ); ?>;"
                <?php } ?>
                type="<?php echo esc_attr( $type ); ?>"
