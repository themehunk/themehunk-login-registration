...
<div class="thlogin-form-header-part">
    <div class="thlogin-header-top-row">
        <?php if ($close_button_settings) : ?>
            <button class="thlogin-popup-close-button thlogin-header-cancel-button" aria-label="<?php esc_attr_e('Close', 'thlogin'); ?>">
    ...
    <?php if (($logo_settings['url'] ?? '')) : ?>
        <div class="thlogin-logo">
            ...
            $logo_html = sprintf(
                ...
                esc_attr__('Plugin Logo', 'thlogin'),
